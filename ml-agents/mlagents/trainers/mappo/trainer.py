...
# ## ML-Agent Learning (MAPPO)
# Contains an implementation of MAPPO as described in: https://arxiv.org/abs/2103.01955
...
class MAPPOTrainer(OnPolicyTrainer):
    """The MAPPOTrainer is an implementation of the MAPPO algorithm."""
    ...
    def __init__(
        ...
        """
        Responsible for collecting experiences and training MAPPO model.
        ...
        self.seed = seed
        self.shared_critic = True  # MAPPO uses shared critic
